        ...
        **kwargs,
        ...
        Args:
            ...
            decomp_trend (bool): default True. whether to decompose the series to estimate the trend.
                ...
                but for seasonality, maybe not so much.
            decomp_method (str): one of 'additive','multiplicative'. default 'additive'.
                ...
                the decomp method used represent the trend if decomp_trend is True.
            ...
            try_seasonalities (bool): default True.
                ...
                this function uses a hierachical approach from minutely --> quarterly representations.
                minutely will search all seasonal representations up to quarterly to find the best hierarchy of seasonalities.
                anything lower than minutely and higher than quarterly will not receive a seasonality with this method.
            ...
            seasonality_repr (list or dict): default ['sincos'].
                ignored if try_seasonalities is False.
                how to represent the extract seasonalties. the default will use fourier representations only.
                ...
                ['sincos'], or a fourier representation.
        ...
        def Xvar_select_forecast(
            ...
            if monitor == 'ValidationMetricValue':
                ...
                if not cross_validate:
                    ...
                    f.cross_validate(**cvwargs,dynamic_tuning=dynamic_tuning)
        ...
        def get_Xvar_combos(
            ...
            if irr_cycles is not None:
                for i in irr_cycles:
                    f.add_cycle(i)
                irr_regressors = ['cycle' + str(i) + 'sin' for i in irr_cycles] + ['cycle' + str(i) + 'cos' for i in irr_cycles]
            else:
                irr_regressors = []
        ...
        if try_trend:
            if decomp_trend:
                try:
                    ...
                    ft = Forecaster(
                        y = decomp_trend,
                        current_dates = decomp_trend.index,
                        require_future_dates=False,
                    )
                except Exception as e:
                    warnings.warn(
                        f'trend decomposition did not work: {e} '
